...
class ConnectionManager:
    ...
    async def connect(self, room_id: str, websocket: WebSocket):
        ...
        print("New active connection are ", self.active_connections)
    ...
    async def send_personal_message(self, message: str, websocket: WebSocket):
        ...
        print("Sent a personal message to ", websocket)
...
async def chatroom(request: Request, room_id: int):
    return templates.TemplateResponse("chatroom.html", {"request": request, "room_id": room_id})
